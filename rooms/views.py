...
class RoomBookings(APIView):
    ...
    def get(self, request, pk):
        ...
        serializer = bookings_serializers.PublicBookingSerializer(bookings, many=True)
        return Response(serializer.data)

    def post(self, request, pk):
        room = self.get_object(pk)
        serializer = bookings_serializers.CreateRoomBookingSerializer(data=request.data)
        if serializer.is_valid():
            ...
            serializer = bookings_serializers.PublicBookingSerializer(booking)
            return Response(serializer.data)
        else:
            return Response(serializer.errors)
